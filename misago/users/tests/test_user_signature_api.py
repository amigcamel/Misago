...
class UserSignatureTests(AuthenticatedUserTestCase):
    ...
    def test_signature_no_permission(self):
        ...
        override_acl(self.user, {'can_have_signature': 0, })
    ...
    def test_signature_locked(self):
        ...
        override_acl(self.user, {'can_have_signature': 1, })
    ...
    def test_post_good_signature(self):
        ...
        response_json = json.loads(smart_str(response.content))
        self.assertEqual(response_json['signature']['html'], '<p>Hello, <strong>bros</strong>!</p>')
        self.assertEqual(response_json['signature']['plain'], 'Hello, **bros**!')
