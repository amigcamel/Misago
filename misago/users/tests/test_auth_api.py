...
class GatewayTests(TestCase):
    ...
    def test_login_inactive_admin(self):
        ...
        User = get_user_model()
        User.objects.create_user('Bob', 'bob@test.com', 'Pass.123', requires_activation=1)
    ...
    def test_login_inactive_user(self):
        ...
        User = get_user_model()
        User.objects.create_user('Bob', 'bob@test.com', 'Pass.123', requires_activation=2)
    ...
    def test_login_disabled_user(self):
        ...
        User = get_user_model()
        user = User.objects.create_user('Bob', 'bob@test.com', 'Pass.123', is_active=False)
