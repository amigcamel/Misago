...
class DenyBannedIPTests(UserTestCase):
    def test_success(self):
        ...
        Ban.objects.create(check_type=BAN_IP, banned_value='83.*', user_message="Ya got banned!")
    ...
    def test_fail(self):
        ...
        Ban.objects.create(check_type=BAN_IP, banned_value='127.*', user_message="Ya got banned!")
